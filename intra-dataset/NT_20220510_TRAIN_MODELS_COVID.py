...
outdir = '/home/data/designproject2122/notebook/NT/Output/COVID'
...
for experimentfolder in subfolders:
    ...
    scores = cross_validate(experiment_method, data, data.obs['Factor Value[inferred cell type - ontology labels]'], scoring=scoring, cv = cv_gen, n_jobs = 2)
