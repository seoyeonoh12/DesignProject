...
import os
import joblib
rootdir = '/home/data/designproject2122/notebook/NT/Input/retry_scaler_SVC_lin'
outdir = '/home/data/designproject2122/notebook/NT/Output/retry2_lin_SVC'
...
dump(results_DF, os.path.join(outdir, "OUTDATAFRAME.joblib"))