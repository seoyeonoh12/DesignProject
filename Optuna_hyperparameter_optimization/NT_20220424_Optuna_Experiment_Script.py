...
Preprocessing_list = [
    [
        ...
        ('normalize', PreprocessingNormalize()),
...
results = experiment.fit(Azimuth_data_downsampled, Azimuth_data_remaining, predict_factor, savemodels=True, cv = 2, n_trails = 1)
results